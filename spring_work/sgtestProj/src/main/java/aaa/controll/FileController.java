...
public class FileController {
	...
	void fileSave(MultipartFile mf) {
		String path = "C:\\green_project\\springworks\\spring_work\\sgtestProj\\src\\main\\webapp\\up";
	...
	void fileSave2(UploadData ud, HttpServletRequest request) {
		...
		path = "C:\\green_project\\springworks\\spring_work\\sgtestProj\\src\\main\\webapp\\up";
